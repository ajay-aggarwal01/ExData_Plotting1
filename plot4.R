...
plot(x2$my_datetime, as.numeric(x2$"Global_active_power"), type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(x2$my_datetime, x2$"Voltage", type="l", xlab="datetime", ylab="Voltage")
...
plot(x2$my_datetime, as.numeric(x2$"Global_reactive_power"), type="l", xlab="datetime", ylab="Global_reactive_power")
